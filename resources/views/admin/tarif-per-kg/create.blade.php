...
@section('title', 'Tambah Tarif Per Kg')
@section('page-title', 'Tambah Tarif Per Kg Baru')

@section('content')
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Form Tambah Tarif Per Kg</h3>
    </div>
    <form action="{{ route('admin.tarif-per-kg.store') }}" method="POST">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                          ...
                          placeholder="Penjelasan tarif ini...">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
